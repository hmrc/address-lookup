...
object SearchParameters {
  private[controllers] val UPRN = "uprn"
  private[controllers] val OUTCODE = "outcode"
  private[controllers] val POSTCODE = "postcode"
  private[controllers] val FUZZY = "fuzzy"
  private[controllers] val FILTER = "filter"
  private[controllers] val TOWN = "town"

  private[controllers] val LINE1 = "line1"
  private[controllers] val LINE2 = "line2"
  private[controllers] val LINE3 = "line3"
  private[controllers] val LINE4 = "line4"
  private[controllers] val LIMIT = "limit"
  ...
  def fromLookupByTownRequest(lookupByTownRequest: LookupByPostTownRequest): SearchParameters = {
    new SearchParameters(town = Some(lookupByTownRequest.posttown), filter = lookupByTownRequest.filter)
  }
